...
public class OrderWide {
    ...
    //firstNonNull 返回参数列表中第一个不为null的值
    public void mergeOtherOrderWide(OrderWide otherOrderWide){
        this.order_status = firstNonNull( this.order_status ,otherOrderWide.order_status);
        this.create_time =  firstNonNull(this.create_time,otherOrderWide.create_time);
        this.create_date =  firstNonNull(this.create_date,otherOrderWide.create_date);
        this.coupon_reduce_amount =  firstNonNull(this.coupon_reduce_amount,otherOrderWide.coupon_reduce_amount);
        this.activity_reduce_amount =  firstNonNull(this.activity_reduce_amount,otherOrderWide.activity_reduce_amount);
        this.original_total_amount =  firstNonNull(this.original_total_amount,otherOrderWide.original_total_amount);
        this.feight_fee = firstNonNull( this.feight_fee,otherOrderWide.feight_fee);
        this.total_amount =  firstNonNull( this.total_amount,otherOrderWide.total_amount);
        this.user_id =  ObjectUtils.<Long>firstNonNull(this.user_id,otherOrderWide.user_id);
        this.sku_id = firstNonNull( this.sku_id,otherOrderWide.sku_id);
        this.sku_name =  firstNonNull(this.sku_name,otherOrderWide.sku_name);
        this.order_price =  firstNonNull(this.order_price,otherOrderWide.order_price);
        this.sku_num = firstNonNull( this.sku_num,otherOrderWide.sku_num);
        this.split_activity_amount= firstNonNull(this.split_activity_amount);
        this.split_coupon_amount= firstNonNull(this.split_coupon_amount);
        this.split_total_amount= firstNonNull(this.split_total_amount);
